...
import CanvaPrintModule from '../../Views/canva-print-module/canva-print-module';
  ...
  return (
    <div className="header">
      ...
      <div className="header-actions">
        <div className="status" style={{ color: '#555', fontSize: '0.85rem' }}>
...
const Footer = () => {
  return (
    ...
    >
      ...
      <div>
        v1.0.0 <span style={{ margin: '0 8px', color: '#ccc' }}>|</span> © 2026
        Traceability System
      </div>
    </div>
  );
...
export default function UnAuthRoutes() {
  ...
  return (
    <Router>
      <div
        className={`app-container ${isSidebarOpen ? 'sidebar-open' : 'sidebar-collapsed'}`}
      >
