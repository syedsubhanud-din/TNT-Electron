...
export default function CanvaPrintModule() {
  ...
  const handleSendData = async () => {
    ...
    let fixSNpayload = [
      {
        ...
        style: {
          font_style: 'ttf-OCR_B-r*nnn*-46-46-UTF-8',
          rotate: 0,
          mirror: 0,
          stretch: 0,
          reverse: 0,
    ...
    try {
      ...
      // Send full payload with canvasSize so Python gets proper dimensions
      const payload = JSON.stringify({
        elements: [...basePayload.elements, ...fixSNpayload],
        canvasSize: basePayload.canvasSize,
      });
      const args = [
        '--payload',
        payload,
